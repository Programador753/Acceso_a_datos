...
namespace AntonioHernandezAPI.Controllers
{
    ...
    public class IngredientsController : ControllerBase
    {
        ...
        public IngredientsController(Contexto context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Ingredient>> PostIngredient(Ingredient ingredient)
        {
          if (_context.Ingredient == null)
          {
              return Problem("Entity set 'Contexto.Ingredient'  is null.");
          }
        ...
        {
            return (_context.Ingredient?.Any(e => e.IdIngredient == id)).GetValueOrDefault();
        }
    }
}
